...
namespace Assignment.Models
{
    ...
    {
        public ToyManufacturingContext(DbContextOptions<ToyManufacturingContext> options) : base(options)
        {
        }
        ...
        //{
        //    contextOptionsBuilder.UseSqlServer(@"Server=DESKTOP-RP7840A\SQLEXPRESS;Database=ToyManufacturing;Trusted_Connection=True;");
        //}
