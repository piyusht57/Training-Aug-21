/*
  (1)Create a list which will store 5 student names and then display it search
     it index number
  
  (2)Create a stack which will store Age of person and display it last in first out order.

  (3)Store a product information in map object. Key will be a product item and value will 
     be the price of that product. Search the product by product name.
 */
using System;
