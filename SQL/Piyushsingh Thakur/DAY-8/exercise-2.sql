...
INSERT INTO Countries (CountryId,CountryName,RegionId) VALUES ('RS','RUSSIA',1)
...
---13. Write a SQL statement to insert rows into the table employees in which a set of columns department_id and manager_id 
...
---14. Write a SQL statement to insert rows into the table employees in which a set of columns department_id and job_id contains 
---    the values which must have exists into the table departments and jobs.
